...
class TestSolvers(unittest.TestCase):
    ...
    def test_cbc_cmd_properties_support(self):
        ...
        try:
            cbc_cmd = devkit.solver.SolverCbcCMD()
        except ImportError:
    ...
    def test_cplex_cmd_properties_support(self):
        ...
        try:
            cplex_cmd = devkit.solver.SolverCplexCMD()
        except ImportError:
    ...
    def test_clp_cmd_properties_support(self):
        ...
        try:
            clp_cmd = devkit.solver.SolverClpCMD()
        except ImportError:
    ...
    def test_ipopt_properties_support(self):
        ...
        try:
            ipopt = devkit.solver.SolverIpopt()
        except ImportError:
    ...
    def test_ipopt(self):
        ...
        prob = devkit.problem.QuadProblem(H,g,A,b,l,u)
        ...
        for x_bad in [np.inf, np.nan]:
            x[int(n/2)] = x_bad
            bad_prob = devkit.problem.QuadProblem(H,g,A,b,l,u,x=x)
            self.assertRaises(devkit.solver.SolverError_Ipopt, Ipopt.solve, bad_prob)
    ...
    def test_cplex_cmd_lp_duals(self):
        ...
        try:
            solver = devkit.solver.SolverCplexCMD()
        except ImportError:
            raise unittest.SkipTest('no cplex cmd')
    ...
    def test_cbc_cmd_lp_duals(self):
        ...
        try:
            solver = devkit.solver.SolverCbcCMD()
        except ImportError:
            raise unittest.SkipTest('no cbc cmd')
    ...
    def test_ipopt_lp_duals(self):
        ...
        try:
            solver = devkit.solver.SolverIpopt()
        except ImportError:
            raise unittest.SkipTest('no ipopt')
    ...
    def test_clp_cmd_lp_duals(self):
        ...
        try:
            solver = devkit.solver.SolverClpCMD()
        except ImportError:
            raise unittest.SkipTest('no clp cmd')
    ...
    def test_clp(self):
        ...
        try:
            solver = devkit.solver.SolverClp()
        except ImportError:
            raise unittest.SkipTest('no clp')
        ...
        qp = devkit.solver.SolverIQP()
        qp.set_parameters({'quiet':True})
        problem1 = devkit.problem.QuadProblem(coo_matrix((5,5)),c,A,b,l,u) 
        qp.solve(problem1)
        ...
        self.assertRaises(devkit.solver.SolverError,solver.solve,4)
    ...
    def test_cbc(self):
        ...
        try:
            solver = devkit.solver.SolverCbc()
        except ImportError:
            raise unittest.SkipTest('no cbc')
    ...
    def test_iqp_random(self):
        ...
        solver = devkit.solver.SolverIQP()
    ...
    def test_solvers_on_LPs(self):
        ...
        for solver in [devkit.solver.SolverIpopt,
                       devkit.solver.SolverINLP,
                       devkit.solver.SolverAugL]:
            ...
            try:
                solver.solve(problem)
            except devkit.solver.SolverError_NotAvailable:
                continue
    ...
    def test_augl_barrier(self):
        ...
        for i in range(10):
            ...
            bounds = devkit.solver.augl.AugLBarrier(n,umin,umax)
