...
class SolverINLP(Solver):
    ...
    def __init__(self):
        ...
        self.parameters = SolverINLP.parameters.copy()
        self.linsolver = None
    ...
    def solve(self, problem):
        ...
        if not np.all(problem.l <= problem.u):
            raise SolverError_NoInterior(self)
        ...
        while True:
            ...
            while True:
                ...
                try:
                    ...
                    raise SolverError_Infeasibility(self)
