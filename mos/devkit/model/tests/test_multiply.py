...
class TestMultiply(unittest.TestCase):
    ...
    def test_contruction(self):
        ...
        f = devkit.model.function.multiply([x, devkit.model.expression.make_Expression(1.)])
        ...
        self.assertRaises(AssertionError, devkit.model.function.multiply, [1., x, 2.])
        self.assertRaises(AssertionError, devkit.model.function.multiply, [x])
        self.assertRaises(TypeError, devkit.model.function.multiply, x)
    ...
    def test_derivative(self):
        ...
        z = devkit.model.variable.VariableScalar(name='z', value=5.)
