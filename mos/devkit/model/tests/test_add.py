...
class TestAdd(unittest.TestCase):
    ...
    def test_contruction(self):
        ...
        f = devkit.model.function.add([x, devkit.model.expression.make_Expression(1.)])
        ...
        self.assertRaises(AssertionError, devkit.model.function.add, [x])
        self.assertRaises(AssertionError, devkit.model.function.add, [])

    def test_constant_constant(self):

        a = devkit.model.constant.Constant(4.)
        b = devkit.model.constant.Constant(5.)
    ...
    def test_scalar_scalar(self):
        ...
        f = x + 1.
        self.assertTrue(isinstance(f, devkit.model.function.add))
        self.assertTrue(f.arguments[0] is x)
        self.assertTrue(isinstance(f.arguments[1], devkit.model.constant.Constant))
        self.assertEqual(f.arguments[1].get_value(), 1.)
        self.assertEqual(f.get_value(), 3.)
        self.assertEqual(str(f), 'x + %s' %devkit.model.utils.repr_number(1.))
        ...
        self.assertEqual(f.get_value(), 9.)
        self.assertEqual(str(f), 'x + %s + y' %devkit.model.utils.repr_number(4.))
    ...
    def test_scalar_matrix(self):
        ...
        value = [[1., 2., 3.], [4., 5., 6.]]
        x = devkit.model.variable.VariableScalar(name='x', value=2.)
        y = devkit.model.variable.VariableMatrix(name='y', value=value)
        ...
        for i in range(2):
            for j in range(3):
                fij = f[i,j]
                self.assertTrue(isinstance(fij, devkit.model.function.add))
    ...
    def test_matrix_matrix(self):
        ...
        x = devkit.model.variable.VariableMatrix(name='x', value=value1)
        y = devkit.model.variable.VariableMatrix(name='y', value=value2)
    ...
    def test_derivative(self):
        ...
        x = devkit.model.variable.VariableScalar(name='x', value=3.)
        y = devkit.model.variable.VariableScalar(name='y', value=4.)

        f = x + 1        
        fx = f.get_derivative(x)
        fy = f.get_derivative(y)
        
        self.assertTrue(isinstance(fx, devkit.model.constant.Constant))
        ...
        self.assertEqual(str(fx), devkit.model.utils.repr_number(2))
