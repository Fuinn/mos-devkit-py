...
class TestSubtract(unittest.TestCase):
    ...
    def test_scalar_scalar(self):
        ...
        self.assertTrue(isinstance(f.arguments[0], devkit.model.constant.Constant))
        ...
        f = 3. - x - y
        self.assertTrue(isinstance(f, devkit.model.function.add))
        self.assertTrue(isinstance(f.arguments[1], devkit.model.function.multiply))
        self.assertTrue(isinstance(f.arguments[2], devkit.model.function.multiply))
    ...
    def test_zero(self):
        ...
        f = 0 - x
        self.assertTrue(isinstance(f, devkit.model.function.multiply))
